...
BEGIN {
    ...
    require '/Users/sethbell/Dev/libimobiledevice_dbuddy/openssl_build/openssl-3.1.1/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/sethbell/Dev/libimobiledevice_dbuddy/openssl_build/openssl-3.1.1/test/fips-and-base.cnf';
    shift;
